...
- python3.9 -m flask init-db
- python3.9 -m flask run

you can use alias run_flask='export FLASK_APP=flaskr; export FLASK_ENV=development; python3.9 -c flask init-db; python3.9 -c flask run'
